    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(237,84,31,0.12)" }}
        >
          {invitation.listIcon}
        </div>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm" style={{ color: "#6b6560" }}>
            <span className="font-semibold" style={{ color: "#1a1918" }}>
              {invitation.invitedByName}
            </span>{" "}
            te invitó a unirte a
          </p>
          <h1 className="text-2xl font-bold" style={{ color: "#1a1918" }}>
            {invitation.listName}
          </h1>
        </div>
      ...
      {/* Footer */}
      <p className="mt-8 text-xs" style={{ color: "#a8a39e" }}>
        © 2025 Dallyst
      </p>
    </main>
  );
